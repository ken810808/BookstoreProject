$(document).ready(function () {
    ...
    $('#btnLogin').click(function () {
        ...
        if (nickName)
        {
            var href = "/Location/Home/Chatroom" + "?user=" + encodeURIComponent(nickName);
            //var href = "/Location/Home/Chatroom" + "?user=" + encodeURIComponent(nickName);
...
function LoginOnSuccess(result) {
    ...
    $("#btnSpeak").click(function () {
        ...
        if (text) {
            ...
            var href = "/Location/Home/Chatroom" + "?user=" + encodeURIComponent($("#YourNickname").text());
            //var href = "/Location/Home/Chatroom" + "?user=" + encodeURIComponent($("#YourNickname").text());
    ...
    $("#btnLogOff").click(function () {
        ...
        var href = "/Location/Home" + "?user=" + encodeURIComponent($("#YourNickname").text());
       // var href = "Location/Home" + "?user=" + encodeURIComponent($("#YourNickname").text());

        href = href + "&logOff=true";
        $("#ActionLink").attr("href", href).click();

        document.location.href = "/Location/Employee/Index";
    });
